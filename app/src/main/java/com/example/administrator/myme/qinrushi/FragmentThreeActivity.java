...
/**      com.example.administrator.myme.qinrushi.FragmentThreeActivity
...
public class FragmentThreeActivity extends BaseActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    protected void initData() {
        ...
        MineThreeFragment homeThreeFragment = new MineThreeFragment();
        MineThreeFragment categoryThreeFragment = new MineThreeFragment();
    ...
    public void onPageSelected(int position) {
        switch (position) {
            ...
            case 1:
                tabSelected(ll_category);
                 //mImmersionBar.statusBarDarkFont(true, 0.2f).navigationBarColor(R.color.colorAccent).init();
                break;
            case 2:
                tabSelected(ll_service);
                 //mImmersionBar.statusBarDarkFont(false).navigationBarColor(R.color.colorPrimary).init();
            ...
            case 3:
                tabSelected(ll_mine);
                 //mImmersionBar.statusBarDarkFont(true).navigationBarColor(R.color.colorAccent).init();
                break;
        }
    }
