package com.example.administrator.myme.listdialog;
...
public class ChangeISNOPicker {
    ...
    public void showAlertDialog(final List<String> list) {
        ...
        View foot_view = LayoutInflater.from(activity).inflate(R.layout.activity_list_dialog_foot, null);
        listView.addFooterView(foot_view);

        listView.setListViewHeight(500);
        TextView textConfirm = (TextView) foot_view.findViewById(R.id.cancel);
        ...
        textConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                alertOnClickListener.alertClick("取消了");
                dlg.dismiss();
            }
        });
    }
